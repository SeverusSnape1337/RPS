...
// MARK: - IB Actions
    ...
    func updateUI(forState state: GameState) {
        ...
        case .win:
            view.backgroundColor = UIColor(displayP3Red: 0.651, green: 0.792, blue: 0.651, alpha: 1)
        case .lose:
            view.backgroundColor = UIColor(displayP3Red: 0.851, green: 0.424, blue: 0.412, alpha: 1)
        case .draw:
            view.backgroundColor = UIColor(displayP3Red: 0.663, green: 0.663, blue: 0.663, alpha: 1)
        }
    }
